...
class Ui_wizard(object):
    def setupUi(self, wizard):
        ...
        self.layoutWidget = QtGui.QWidget(self.wizardPage_2)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 601, 141))
        self.layoutWidget.setObjectName(_fromUtf8("layoutWidget"))
        self.verticalLayout_3 = QtGui.QVBoxLayout(self.layoutWidget)
        self.verticalLayout_3.setObjectName(_fromUtf8("verticalLayout_3"))
        self.commandLinkButton_seq = QtGui.QCommandLinkButton(self.layoutWidget)
        ...
        self.layoutWidget1 = QtGui.QWidget(self.wizardPage_3)
